...
NOTION_DATABASE_URL_FIELD = "notion_database_url"
NOTION_DATABASE_NAME_FIELD = "notion_database_name"
REQUIRED_CONFIG_FIELDS = [NOTION_API_KEY_FIELD, NOTION_DATABASE_URL_FIELD, NOTION_DATABASE_NAME_FIELD]
...
def get_user_info():
    ...
    if not os.path.exists(os.path.join(os.curdir, CONFIG_FILE_NAME)):
        ...
        with open(CONFIG_FILE_NAME, "w") as file:
            ...
            user_data[NOTION_DATABASE_URL_FIELD] = database_id
